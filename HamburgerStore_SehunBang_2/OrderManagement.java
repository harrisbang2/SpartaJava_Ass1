...
public class OrderManagement {
    ...
    public void addCartToOrder(int orderNumber, String message, List<Items> cart, Double totalPrice) {
        List<Items> orderItemList = new ArrayList<>(cart);
    ...
    public Items createMenuItem() {
        ...
        return new Items(name, price, description);
    }

    public void deleteMenuItems(Map<String, List<Items>> menuItems, int itemId) {
